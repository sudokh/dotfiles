...
if has('vim_starting')
  ...
  augroup OpenDir
    ...
    autocmd VimEnter * call s:cd_desktop()
    autocmd VimEnter * call s:fullscreen()
  augroup END
endif

let mapleader = "\<Space>"

nnoremap <Leader>d :e +10 $DESKTOP<CR>

nnoremap <C-e> :e!<CR>

nnoremap <Leader><CR> :silent ! start %<CR>

nnoremap <Leader>D :silent ! start $DESKTOP<CR>
...
nnoremap <Leader>R :source $VIM/gvimrc<CR>
